...
CREATE INDEX IF NOT EXISTS package_gyms_package_idx ON public.package_gyms(package_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS package_gyms_gym_idx ON public.package_gyms(gym_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS gyms_status_idx ON public.gyms(status);
CREATE INDEX IF NOT EXISTS gym_slots_time_idx ON public.gym_slots(start_time);
...
CREATE INDEX IF NOT EXISTS user_subscriptions_user_expiry_idx ON public.user_subscriptions(user_id, expiry_date DESC);
