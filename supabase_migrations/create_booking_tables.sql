-- Unified booking schema setup.
-- This file is the single source of truth for booking module DB setup.
...
DROP TABLE IF EXISTS gym_slots CASCADE;
DROP TABLE IF EXISTS package_gyms CASCADE;
